...
const defaultConfig = (environnement, definedVariables) => {
    ...
    if (localFocus) {
        config.addAlias("focus-core-updated", path.resolve(process.cwd(), "../focus-core-updated"));
        config.addAlias("focus-components-updated", path.resolve(process.cwd(), "../focus-components-updated"));
    }
