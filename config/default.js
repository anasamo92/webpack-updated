...
var defaultConfig = function defaultConfig(environnement, definedVariables) {
    ...
    if (localFocus) {
        config.addAlias('focus-core-updated', _path2.default.resolve(process.cwd(), '../focus-core-updated'));
        config.addAlias('focus-components-updated', _path2.default.resolve(process.cwd(), '../focus-components-updated'));
    }
